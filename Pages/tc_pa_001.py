...
class tc_pa_001(HomePage):
    ...
    def microsoftEmail(self, mail):
        wait = WebDriverWait(self.driver, 60)
        loginEmail = wait.until(EC.visibility_of_element_located((By.ID, "i0116")))
        loginEmail.send_keys(mail)

    def microsoftEmailBtn(self):
        wait = WebDriverWait(self.driver, 60)
        loginEmail = wait.until(EC.visibility_of_element_located((By.ID, "idSIButton9")))
        loginEmail.click()

    def microsoftPassword(self, passwd):
        wait = WebDriverWait(self.driver, 60)
        password = wait.until(EC.visibility_of_element_located((By.ID, "i0118")))
        password.send_keys(passwd)

    def microsoftPasswordBtn(self):
        wait = WebDriverWait(self.driver, 60)
        passwordBtn = wait.until(EC.visibility_of_element_located((By.ID, "idSIButton9")))
        passwordBtn.click()

    def rememberCheck(self):
        wait = WebDriverWait(self.driver, 60)
        rememberCheck = wait.until(EC.visibility_of_element_located((By.ID, "KmsiCheckboxField")))
        rememberCheck.click()

    def rememberBtn(self):
        wait = WebDriverWait(self.driver, 60)
        rememberBtn = wait.until(EC.visibility_of_element_located((By.ID, "idBtn_Back")))
        rememberBtn.click()
    ...
    def regProduct(self):
        ...
        reg = wait.until(EC.visibility_of_element_located(
            (By.XPATH, "//*[@id='ruleform']/div/div/div[1]/div[2]/div[1]/div/span/div/ul/li[1]/a/label")))
        reg.click()
    ...
    def competetorTypeSelect(self):
        ...
        type = wait.until(
            EC.visibility_of_element_located(
                (By.XPATH, '//*[@id="ruleform"]/div/div/div[3]/div/span/div/ul/li[2]/a/label')))
        type.click()

    def refProduct(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[4]/div/span/div/button')))
        product.click()
    ...
    def refProductSelect(self):
        ...
        product = wait.until(
            EC.visibility_of_element_located(
                (By.XPATH, '//*[@id="ruleform"]/div/div/div[4]/div/span/div/ul/li[2]/a/label')))
        product.click()

    def referenceCalculation(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[5]/div/span/div/button')))
        calc.click()

    def referenceCalcType(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(EC.visibility_of_element_located(
            (By.XPATH, '//*[@id="ruleform"]/div/div/div[5]/div/span/div/ul/li[1]/a/label')))
        calc.click()

    def plusIcon(self):
        wait = WebDriverWait(self.driver, 60)
        plus = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[7]/div/label[1]')))
        plus.click()
    ...
    def checkTest(self):
        ...
        test = wait.until(EC.visibility_of_element_located(
            (By.XPATH, "(//*[name()='text'][@class='highcharts-axis-title'][normalize-space()='Volume'])[1]")))
