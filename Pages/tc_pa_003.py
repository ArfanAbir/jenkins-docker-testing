...
class TC_PA_003(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(TC_PA_003, self).__init__(driver)
    ...
    def regProduct(self):
        ...
        reg = wait.until(EC.visibility_of_element_located(
            (By.XPATH, "//*[@id='ruleform']/div/div/div[1]/div[2]/div[1]/div/span/div/ul/li[2]/a/label")))
        reg.click()
    ...
    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[4]/div/span/div/ul/li[3]/a/label')))
        product.click()
    ...
    def referenceCalcType(self):
        wait = WebDriverWait(self.driver, 60)
        calc = wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[5]/div/span/div/ul/li[1]/a/label')))
        calc.click()
