...
class TC_PA_002(HomePage):

    def __init__(self, driver):
        self.driver = driver
        super(TC_PA_002, self).__init__(driver)
    ...
    def refProductSelect(self):
        wait = WebDriverWait(self.driver, 60)
        product = wait.until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="ruleform"]/div/div/div[4]/div/span/div/ul/li[7]/a/label')))
        product.click()
